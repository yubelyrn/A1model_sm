...
cfg.analysis['plotTraces'] = {'include': [('TC', i) for i in range(15)], 'oneFigPer': 'pop', 'overlay': True, 'saveFig': True, 'showFig': False, 'figSize':(12,8)} #[(pop,0) for pop in alltypes]		## Seen in M1 cfg.py (line 68)
...
if cfg.cochlearThalInput:
    cfg.cochlearThalInput = {"lonset" : [3000, 3724, 4448, 5172], "numCenterFreqs": 100, "freqRange":[125, 20000], "loudnessScale": 1,
                             "lfnwave": ["40Hz_100ms.wav", "40Hz_100ms.wav", "40Hz_100ms.wav", "40Hz_100ms.wav"]}
