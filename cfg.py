...
cfg.analysis['plotTraces'] = {'include': [('TC', i) for i in range(15)], 'timeRange': [3000, cfg.duration], 'oneFigPer': 'trace', 'overlay': True, 'saveFig': True, 'showFig': False, 'figSize':(12,8)} #[(pop,0) for pop in alltypes]		## Seen in M1 cfg.py (line 68)
