...
cfg.synWeightFractionNGF = dconf['syn']['synWeightFractionNGF'] # [0.5, 0.5] # NGF GABAA to GABAB ratio
cfg.synWeightFractionENGF = dconf['syn']['synWeightFractionENGF'] # [0.834, 0.166] # NGF AMPA to NMDA ratio
cfg.useHScale = False
...
cfg.synWeightFractionIE = dconf['syn']['synWeightFractionIE'] # [0.9, 0.1]  # SOM -> E GABAASlow to GABAB ratio (update this)
cfg.synWeightFractionII = dconf['syn']['synWeightFractionII'] # [0.9, 0.1]  # SOM -> E GABAASlow to GABAB ratio (update this)
      ...
      for post in TEpops+TIpops:
          if post in pmat[pre]:
              ...
              if pre in TEpops:     # E->E/I
                  ...
                  syn = SOMESynMech
                  synWeightFactor = dconf['syn']['Thal']['I']['E'] # cfg.synWeightFractionIE
              else:                  # I->I
                  syn = SOMISynMech
                  synWeightFactor = [1.0]
